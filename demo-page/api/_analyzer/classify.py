"""Deployment-local copy of analyzer/static/classify.py for the upload-and-analyze
endpoint (Vercel's Root Directory can't reach files outside demo-page/). Keep in sync
by hand.
